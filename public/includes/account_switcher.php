...
// Inclure la vérification DB
if (file_exists(__DIR__ . '/db_check.php')) {
    include __DIR__ . '/db_check.php';
}

// Récupérer les données nécessaires
if ($_SESSION['user_role'] === 'parent' && isset($pdo)) {
    try {
        $stmt = $pdo->prepare("
        ...
        error_log("Account switcher error: " . $e->getMessage());
        $children = [];
    }
} else {
    $children = [];
...
// Si le widget est inclus depuis /public/parent/dashboard.php, on a besoin de ../
// Si depuis /public/index.php, pas besoin
$base_path = '';
if (strpos($_SERVER['PHP_SELF'], '/parent/') !== false) {
    $base_path = '../';
}
?>

<!-- Widget de bascule de compte -->
<?php if ($_SESSION['user_role'] === 'parent' && !empty($children)): ?>
        ...
        <div style="max-height: 300px; overflow-y: auto;">
            ...
            <div class="child-option" style="padding: 15px; border-bottom: 1px solid #f3f4f6;">
                ...
                <div style="display: flex; gap: 10px;">
                    ...
                    <a href="<?php echo $base_path; ?>public/switch_account.php?switch_to=student&target_id=<?php echo $child['id']; ?>&mode=view" 
                       style="
                            flex: 1;
                            background: #10B981;
                            color: white;
                    ...
                    <a href="<?php echo $base_path; ?>public/switch_account.php?switch_to=student&target_id=<?php echo $child['id']; ?>" 
                       style="
                            flex: 1;
                            background: #6366F1;
                            color: white;
...
<div style="position: relative; display: inline-block;">
    ...
    ">
        <div style="padding: 15px; background: #f8f9fa; border-bottom: 1px solid #e5e7eb;">
            <div style="font-weight: 600; color: #374151;">Aucun enfant</div>
            <div style="font-size: 0.9rem; color: #6b7280; margin-top: 5px;">
        ...
        <div style="padding: 20px; text-align: center;">
            ...
            <a href="<?php echo $base_path; ?>parent/add_child.php" class="btn btn-primary" style="width: 100%;">
